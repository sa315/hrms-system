    ...
    <main className="min-h-screen bg-gray-950 text-white">
      ...
      <section className="flex flex-col items-center justify-center text-center py-32 px-6">
        ...
        <p className="text-gray-400 mt-6 text-lg max-w-2xl">
          Manage attendance, GPS verification,
          face recognition, leaves,
          payroll deductions, and employee
          monitoring from one powerful platform.
        </p>
        ...
        <div className="flex gap-4 mt-10">
          ...
          <button
            ...
            className="border border-gray-700 hover:border-gray-500 px-6 py-3 rounded-xl text-lg"
          >
            Learn More
          </button>
